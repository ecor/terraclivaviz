...
#dataset_sf <- "/home/ecor/local/rpackages/jrc/terraclivaviz/inst/ext_data/gadm1_goma_kivu_area.shp" %>% st_read()
dataset_sf <- system.file("ext_data/gadm1_goma_kivu_area.shp",package="terraclivaviz") %>% st_read()
